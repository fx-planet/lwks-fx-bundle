...
//
// An alpha transition that splits title(s) into strips and
// compresses them to zero height.  The vertical centring
// can be adjusted so that the title collapses symmetrically.
//
