...
// image halves apart rather than just wipe them off.
//
// Alpha levels are boosted to support Lightworks titles, which is the default setting.
// The boost amount is tied to the incoming and outgoing titles.  The boost technique
// uses gamma to adjust the alpha levels.  This visually matches the way that Lightworks
