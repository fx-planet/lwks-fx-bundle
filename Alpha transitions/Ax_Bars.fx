...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_Bars.fx
//
// An alpha transition that splits a title into strips then blows them apart either
// horizontally or vertically.
//
// The alpha level can be boosted to support Lightworks titles, which is the default.
// The boost is designed to give the same result as Lightworks' internal title handling.
//
...
<
   ...
   string Description = "Alpha bar wipe";
   string Category    = "Mix";
