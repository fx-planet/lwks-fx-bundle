...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_Blocks.fx
//
// This effect is used to transition into or out of a title.  It also composites the
// result over a background layer.
//
...
// titles, which is the default setting.  The boost is designed to give the same result
// as Lightworks' internal title handling.
//
