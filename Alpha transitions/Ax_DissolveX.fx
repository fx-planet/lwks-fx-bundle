...
//-----------------------------------------------------------------------------------------//
// User effect Ax_DissolveX.fx
//
// This expanded alpha dissolve allows blend modes to be applied during the transition
// using a drop down menu to select different dissolve methods.  Although dissolveX.fx
// by khaver was a trigger for this, this implementation is entirely my own.  While I
// have retained some of the blend selections in his original, they are very definitely
// not the Lightworks ones that he used.  The intention behind this effect was to get as
// close as possible visually to the standard Photoshop blend modes, so I didn't look at
// khaver's or Editshare's until after I had produced the ones that you see here.
//
...
<
   ...
   string Description = "Alpha dissolveX";
   string Category    = "Mix";
