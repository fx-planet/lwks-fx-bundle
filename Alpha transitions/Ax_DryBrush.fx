...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_DryBrush.fx
//
// This mimics the Photoshop angled brush stroke effect to reveal or remove a title.
// The stroke length and angle can be independently adjusted, and can be keyframed
// while the transition happens to make the effect more dynamic.
//
...
<
   ...
   string Description = "Alpha dry brush mix";
   string Category    = "Mix";
