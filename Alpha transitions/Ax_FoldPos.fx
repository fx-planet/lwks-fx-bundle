...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_FoldPos.fx
//
// This transitions by adding the title to the background.  The overflowed result is
...
<
   ...
   string Description = "Alpha folded pos dissolve";
   string Category    = "Mix";
