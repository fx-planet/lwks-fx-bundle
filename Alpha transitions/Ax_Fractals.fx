...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_Fractals.fx
//
// This effect uses a fractal-like pattern to transition into or out of a title.  It
// also composites the result over a background layer.  Alpha levels are boosted to
