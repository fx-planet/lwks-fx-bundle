...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_NonAddUltra.fx
//
// This is an extreme non-additive mix for titles.  The incoming title is faded in to
// full value at the 50% point, at which stage the background video starts to fade out.
// The two images are mixed by giving the source with the maximum level priority.
//
...
<
   ...
   string Description = "Alpha ultra non-add dissolve";
   string Category    = "Mix";
