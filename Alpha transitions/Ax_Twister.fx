...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Ax_Twister.fx
//
...
// obtainable with differing combinations of settings is almost inifinite.  Alpha levels
// can be boosted to support Lightworks titles, which is the default setting.
//
...
technique Ax_Twister_in
{
   pass P_1
   { PixelShader = compile PROFILE ps_main_in (); }
}

technique Ax_Twister_out
{
   pass P_1
