...
//-----------------------------------------------------------------------------------------//
// PencilSketchWin.fx for Lightworks was adapted by user khaver 24 May 2018 from original
...
//
// Modified jwrl 2018-05-25.
// Defined PROFILE to make this implementation suitable for legacy versions of Lightworks
// on Windows.  It should not be used for any other version of Lightworks.
//-----------------------------------------------------------------------------------------//

int _LwksEffectInfo
<
   string EffectGroup = "GenericPixelShader";
   string Description = "Pencil Sketch for Windows";
