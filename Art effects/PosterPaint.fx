...
//
// This effect posterizes the image.  The adjustment runs from 0 to 20, with zero being
// two steps of posterization (black and white) and twenty being normal video.  The input
// video can be graded prior to the posterization process.
//-----------------------------------------------------------------------------------------//

//=========================================================================================//
// For full licence details see https://www.gnu.org/licenses/gpl-3.0.en.html
//=========================================================================================//
