...
/**
 Fractal matte 1 produces backgrounds generated from a fractal pattern.  The rate of
...
DeclareLightworksEffect ("Fractal matte 1", "Mattes", "Backgrounds", "Produces fractal patterns for background generation", "CanSize|HasMinOutputSize");
...
DeclareEntryPoint (FractalMatte1)
{
