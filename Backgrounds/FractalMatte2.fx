...
/**
Fractal matte 2 produces backgrounds generated from fractal patterns.
*/
...
sampler s_Image_1 = sampler_state { Texture = <Image_1>; };
sampler s_Image_2 = sampler_state { Texture = <Image_2>; };
...
float4 ps_distort (float2 uv : TEXCOORD, uniform sampler extSampler, uniform bool first_pass) : COLOR
{
...
technique FractalMatte2
{
   ...
   >
   {
      PixelShader = compile PROFILE ps_distort (s_Image_1, true);
   }
   ...
   >
   {
      PixelShader = compile PROFILE ps_distort (s_Image_2, false);
   }
