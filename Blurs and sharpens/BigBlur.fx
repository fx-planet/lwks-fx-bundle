...
// @Author khaver
// @Created 2011-08-29
// @see https://www.lwks.com/media/kunena/attachments/6375/BigBlur_640.png

/**
Smooth blur using a 12 tap circular kernel that rotates 5 degrees for each of 6 passes.
There's a checkbox for a 10 fold increase in the blur amount should greater blurs be
necessary.
*/
...
<
   ...
   string Notes       = "A smooth blur with a checkbox for a 10 fold increase in the blur amount for heavy blurs";
> = 0;
