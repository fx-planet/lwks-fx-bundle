...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect ZoomInSimple220605.fx
//
// Version history:
//
...
DeclareLightworksEffect ("Zoom in, simple", "DVE", "DVE Extras", "Designed for simple zooming in (not recommended for negative zoom values).", CanSize);
