...
//
// This effect is a combination of two previous effects, Pinch_Ax and Pinch_Adx.
//
// Version history:
//
...
<
   ...
   string Description = "Pinch (keyed)";
   string Category    = "Mix";
   string SubCategory = "DVE transitions";
   string Notes       = "Pinches the foreground to a user-defined point to either hide or reveal it";
   bool CanSize       = true;
> = 0;
