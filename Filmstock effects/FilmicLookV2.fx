//--------------------------------------------------------------//
// Lightworks user effect FilmicLookV2.fx
//
...
sampler colSampler = sampler_state { Texture = <Cgrade>; };
sampler clpSampler = sampler_state { Texture = <Clipped>; };
sampler gloSampler = sampler_state { Texture = <Halo>; };
