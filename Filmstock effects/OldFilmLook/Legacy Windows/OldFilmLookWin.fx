...
//-----------------------------------------------------------------------------------------//
// OldFilmLookWin.fx for Lightworks was adapted by user khaver 20 June 2018 from original
...
//
// Modified jwrl 2018-06-20:
// Modified to support legacy Windows versions.  Shader profile 3.0 enforced.
//-----------------------------------------------------------------------------------------//

int _LwksEffectInfo
<
   string EffectGroup = "GenericPixelShader";
   string Description = "Old Film Look (Windows)";
...
technique SampleFxTechnique
{
   ...
   >
   {
      PixelShader = compile ps_3_0 mainImage1();
   }


   pass pass_two
   {
      PixelShader = compile ps_3_0 mainImage2();
   }
}
