...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect PolyMask14Win.fx
//
// User adjustable mask with 14 sides.  The edges of the mask can be feathered, and a
// surround colour can be set.
//
// 21 March 2018: Version 14.5 modification by jwrl
// This will now only compile on Lightworks versions running under Windows.  If running
// Lightworks version 14.5 or higher it is advised that you use the compatible version.
// All Linux and OS-X Lightworks users should also use that version.
//
...
technique PolyMask14
{
   ...
   >
   {
      PixelShader = compile ps_3_0 main1(0);
   }
   pass Pass2
   <
   ...
   >
   {
      PixelShader = compile ps_3_0 main1(1);
   }
   pass Pass3
   {
