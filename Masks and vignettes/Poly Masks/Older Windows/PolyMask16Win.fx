...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect PolyMask16Win.fx
//
// User adjustable mask with sixteen sides.  The edges of the mask can be feathered,
// and a background colour can be set.
//
