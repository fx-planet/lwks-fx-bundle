...
/**
This a user adjustable mask with three sides.  The edges of the mask can be feathered, and
a background colour can be set.
*/

//-----------------------------------------------------------------------------------------//
// Lightworks user effect PolyMask03.fx
//
...
<
   ...
   string Description = "PolyMask 03";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "A three sided adjustable mask with feathered edges and optional background colour";
> = 0;
