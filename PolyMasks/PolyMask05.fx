...
<
   ...
   string Description = "PolyMask 5";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "A five sided adjustable mask with feathered edges and optional background colour";
   bool CanSize       = true;
> = 0;
