...
/**
This a user adjustable mask with six sides.  The edges of the mask can be feathered, and a
background colour can be set.
*/

//-----------------------------------------------------------------------------------------//
// Lightworks user effect PolyMask06.fx
//
...
<
   ...
   string Description = "PolyMask 06";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "A six sided adjustable mask with feathered edges and optional background colour";
> = 0;
