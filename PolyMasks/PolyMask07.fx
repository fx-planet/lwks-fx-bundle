...
/**
This a user adjustable mask with seven sides.  The edges of the mask can be feathered, and
...
<
   ...
   string Description = "PolyMask 07";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "A seven sided adjustable mask with feathered edges and optional background colour";
> = 0;
