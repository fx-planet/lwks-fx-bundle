...
/**
 This a user adjustable mask with eight sides.  The edges of the mask can be feathered, and
...
<
   ...
   string Description = "PolyMask 8";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "An eight sided adjustable mask with feathered edges and optional background colour";
   bool CanSize       = true;
> = 0;
