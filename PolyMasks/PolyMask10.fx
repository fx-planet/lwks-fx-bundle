...
/**
 This a user adjustable mask with ten sides.  The edges of the mask can be feathered, and a
 background colour can be set.
*/

//-----------------------------------------------------------------------------------------//
// Lightworks user effect PolyMask10.fx
//
// Version history.
//
...
<
   ...
   string Description = "PolyMask 10";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "A ten sided adjustable mask with feathered edges and optional background colour";
> = 0;
