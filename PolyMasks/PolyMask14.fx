...
/**
 This a user adjustable mask with fourteen sides.  The edges of the mask can be feathered,
 and a background colour can be set.
*/

//-----------------------------------------------------------------------------------------//
// Lightworks user effect PolyMask14.fx
//
// Version history.
//
...
<
   ...
   string Description = "PolyMask 14";
   string Category    = "DVE";
   string SubCategory = "Polymasks";
   string Notes       = "A fourteen sided adjustable mask with feathered edges and optional background colour";
> = 0;
