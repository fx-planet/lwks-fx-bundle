...
/**
This effect is designed to be a very straightforward portrait to landscape rotator or 180
degree rotator.  This it does very effectively over a mixture of backgrounds.  With all
background mix settings set to zero a transparent black surround is produced, and the
resulting image may be blended with other effects.
...
background fader and overrides it.  The background fader simply fades from black to 100%
level.
*/
