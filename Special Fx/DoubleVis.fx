...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect DoubleVis.fx
//
// Gives a blurry double vision effect suitable for removing glasses or drunken or head
// punch effects.  The blur adjustment is scaled by the displacement amount, so that when
// the amount reaches zero the blur does also.  The displacement is produced by scaling
