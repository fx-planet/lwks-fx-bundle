...
// @Author jwrl
// @Created 2018-09-04
// @see https://www.lwks.com/media/kunena/attachments/6375/RainbowConnection_640.png
//-----------------------------------------------------------------------------------------//
// Lightworks user effect RainbowConnection.fx
//
// This effect changes tones through a complex colour translation while performing what is
// essentially a non-additive mix.  It can be adjusted to operate over a limited range of
// the input video levels or the full range.
//-----------------------------------------------------------------------------------------//
