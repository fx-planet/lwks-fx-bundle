...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Transporter_II.fx
//
...
//
// Because the key settings are of so little importance to the final effect they have
// been re-ordered to fall below the star settings, unlike the chromakey version.
//-----------------------------------------------------------------------------------------//

int _LwksEffectInfo
<
   string EffectGroup = "GenericPixelShader";
   string Description = "Transporter II";
   string Category    = "Key";
...
float4 ps_main (float2 uv1 : TEXCOORD1, float2 uv2 : TEXCOORD2) : COLOR
{
   ...
   float4 retval = lerp (Fgd, tex2D (s_Background, uv2), Amount);
