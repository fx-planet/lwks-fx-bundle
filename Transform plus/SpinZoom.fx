...
/**
 This has some of the same functions as the Lightworks transform 3D, but the settings menu
 does not look as interesting as that effect.  It is actually more interesting.  It gives
