...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Dx_Abstraction2.fx
//
// This based on my earlier effect Abstraction #1.  It uses the same pattern but applies
...
<
   ...
   string Description = "Abstraction #2";
   string Category    = "Mix";
...
float4 ps_main (float2 uv1 : TEXCOORD1, float2 uv2 : TEXCOORD2) : COLOR
{
   ...
   else if (Amount > 0.75) Fgnd = lerp (Bgnd, Fgnd, sin (min (amount * TWO_PI, HALF_PI)));
