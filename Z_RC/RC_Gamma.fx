...
// @Author schrauber
// @Created 2017-02-01
// exceptional aspect ratio: https://www.lwks.com/media/kunena/attachments/348533/RC-Gamma.JPG
//--------------------------------------------------------------//
...
float4 Gamma( float2 xy : TEXCOORD1 ) : COLOR
{
   ...
   return float4 (pow (retval.rgb, 1 / max (RECEIVING (Ch) + 1, 1E-6)), retval.a);
}
