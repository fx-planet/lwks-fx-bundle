...
// @Version: 1.2
//--------------------------------------------------------------//
// Lightworks user effect RC_Lift_old.fx
//
...
// Otherwise, please use the current version of this effect (RC_Lift.fx).
//
//
//
//
...
float4 main( float2 xy : TEXCOORD1 ) : COLOR
{
   ...
   return float4 (min (retval.rgb + RECEIVING(Ch), 1.0), retval.a);
}
