...
//-----------------------------------------------------------------------------------------//
// Lightworks user effect Abstract_3_Dx_2022.fx
//
// Version history:
//
...
DeclareLightworksEffect ("Abstraction #3 2022+", "Mix", "Abstract transitions", "An abstract geometric transition between two opaque sources", "CanSize");
