...
//
// This effect is a combination of two previous effects, Sine_Ax and Sine_Adx.
//
// Version history:
//
...
<
   ...
   string Description = "Sinusoidal mix (keyed)";
   string Category    = "Mix";
   string SubCategory = "Special Fx transitions";
   string Notes       = "Uses a sine wave distortion to transition into or out of the blended foreground";
   bool CanSize       = true;
> = 0;
