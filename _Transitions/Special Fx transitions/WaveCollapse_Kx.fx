...
DeclareEntryPoint (WaveCollapse_F)
{
   ...
   return lerp (ReadPixel (Fg, uv1), Fgnd, Fgnd.a * saturate (Amount * 5.0));
}
...
DeclareEntryPoint (WaveCollapse_I)
{
   ...
   return lerp (ReadPixel (Bg, uv2), Fgnd, Fgnd.a * saturate (Amount * 5.0));
}
...
DeclareEntryPoint (WaveCollapse_O)
{
   ...
   return lerp (ReadPixel (Bg, uv2), Fgnd, Fgnd.a * saturate ((1.0 - Amount) * 5.0));
}
